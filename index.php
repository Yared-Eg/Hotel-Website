    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1  class="animated fadeInDown" style="color:red">Best hotel in Addis Ababa</h1>
                <p class="animated fadeInUp" style="color:black">Most luxurious hotel of Ethiopia with the royal treatments and excellent customer service.</p>                
            </div>
